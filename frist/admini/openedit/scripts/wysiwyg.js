...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		this.ImagesDir = "openedit/images/";
		
		// Popups Directory
		this.PopupsDir = "openedit/addons/insert_image.php";
		
		// CSS Directory File
		this.CSSFile = "openedit/styles/wysiwyg.css";		
		...
		this.ImagePopupFile = "";
		this.ImagePopupWidth = 950;
		this.ImagePopupHeight = 530;
	...
	execCommand: function(n, cmd, value) {
		...
		var imagePopupFile = this.config[n].PopupsDir; //zhangqiang
